...
\subsection{Fiabilisation des variables indicatrices marquants la pr\'esence d'un montant}
...
\begin{figure}[H]
    \begin{center}
      \includegraphics[scale=0.13]{Static/Algorithm_INDICATRICE.png} 
      \end{center}
