...
\pagestyle{fancy}
\fancyhf{}
\rhead{ \flushright \footnotesize \hspace{1.5cm}
Detection with Apache Griffin and correction of data quality problems of the data of the Digital Factory of Saham Assurance Maroc }
\lhead{ \includegraphics[scale=0.10, height= 0.75cm]{Static/sanlam.jpeg}}
\lfoot{\footnotesize Aurel C\'ephas Ogoudjobi ATTERE}
...
\fancypagestyle{plain}{%
  ...
  \fancyhead[R]{ \flushright \footnotesize \hspace{1.5cm} 
Detection with Apache Griffin and correction of data quality problems of the data of the Digital Factory of Saham Assurance Maroc  }
  \fancyfoot[L]{\footnotesize Aurel C\'ephas Ogoudjobi ATTERE}%
...
\includepdf{../Page_de_garde/PageDeGardeAurelAnglaisV1}
\includepdf{../Page_de_garde/Aurel_eng_signature_page-0001-ConvertImage}
%\tableofcontents
%\addto\captions{\def\tablename{{Tableau }}}
...
%\clearpage
\printnoidxglossary[type=acronym, title=Acronyms, toctitle=Acronyms]
